      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
           ...
           <div className="lg:col-span-1 flex">
              {(!user?.abonnement || user?.abonnement === 'gratuit') ? (
                 ...
                 <div className="w-full rounded-3xl bg-gradient-to-br from-[#221ab7] to-[#18adf2] p-8 shadow-xl flex flex-col justify-center items-center text-center relative overflow-hidden text-white">
