...
export default function AuthPage({ initialMode = 'login' }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 bg-[#030712] overflow-hidden font-sans relative">
      ...
      {/* Main Container */}
      <div className="relative w-full max-w-5xl h-[900px] sm:h-[850px] lg:h-[650px] bg-[#0F172A]/80 backdrop-blur-3xl rounded-[2rem] md:rounded-[3rem] border border-white/10 shadow-[0_0_100px_rgba(34,26,183,0.2)] overflow-hidden flex flex-col lg:block">
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-sm mx-auto h-[700px] sm:h-[650px] lg:h-[550px]">
